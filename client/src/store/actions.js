// action types
//user
export const SET_IS_USER_SIGNED_IN = "ET_IS_USER_SIGNED_IN";
...
export const SORT_MONTH_EXPENSES_BY_CATEGORY =
...
export const SET_NOTIFICATION_AMOUNT_REQUIRED =
  "SET_NOTIFICATION_AMOUNT_REQUIRED";
export const SET_NOTIFICATION_EMAIL_AND_PASS_REQUIRED =
  "SET_NOTIFICATION_EMAIL_AND_PASS_REQUIRED";

// action creators
// user
export function setIsUserSignedIn(isUserSignedIn) {
  return { type: SET_IS_USER_SIGNED_IN, isUserSignedIn };
}
