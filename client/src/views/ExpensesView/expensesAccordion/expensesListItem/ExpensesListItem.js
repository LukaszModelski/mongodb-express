  ...
  return (
    <View style={listItemStyles.listItem} key={item._id}>
      <TouchableOpacity
        ...
        style={listItemStyles.descriptionContainer}
      >
        <Text style={[listItemStyles.amount, listItemStyles.textBlue]}>
          {item.amount} zł
        </Text>
      ...
      <View
        style={[
          listItemStyles.editPanel,
          isPanelOpen
            ? listItemStyles.editPanelOpen
            : listItemStyles.editPanelClose,
        ]}
      >
